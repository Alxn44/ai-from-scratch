...
export const NARRATIVA: Record<Mercado, { es: Copy; en: Copy }> = {
  co: {
    es: {
      ...
      prueba: ['Lo escribió una persona con nombre y correo, en Medellín.', 'USD 9.99 al mes. Sin permanencia: cancelas en un clic.', 'PSE, efectivo en Efecty, tarjeta o wallet.'],
      pagoTit: 'Cómo pagas desde Colombia',
      pagoTxt: 'El cobro lo procesa Mercado Pago. El precio está en dólares, así que tu banco hace la conversión del día y puede sumar su comisión: eso no lo controlamos nosotros.',
      ...
      moneda: 'USD 9.99 al mes · lo convierte tu banco',
    },
    en: {
      ...
      prueba: ['Written by one person with a name and an email, in Medellín.', 'USD 9.99 a month. No minimum term: cancel in one click.', 'Card, PSE, cash at Efecty or the Mercado Pago wallet.'],
      pagoTit: 'How you pay from Colombia',
      pagoTxt: 'Mercado Pago processes the charge. The price is in dollars, so your bank does the day’s conversion and may add its own fee, which is outside our control.',
      ...
      moneda: 'USD 9.99 a month · converted by your bank',
    },
  },
  latam: {
    es: {
      ...
      prueba: ['Contenido en español e inglés, lo cambias en un clic.', 'USD 9.99 al mes, cancelas cuando quieras.', 'Responde una persona, en menos de 24 h hábiles.'],
    ...
    en: {
      ...
      prueba: ['Content in Spanish and English, switched in one click.', 'USD 9.99 a month, cancel whenever you want.', 'A person answers, in under 24 business hours.'],
  ...
  us: {
    es: {
      ...
      prueba: ['USD 9.99 al mes. El precio no es un gancho: no hay plan pro.', 'Cero analítica y cero anuncios: tres cookies y nada más.', 'Devolución de 14 días, sin preguntas.'],
    ...
    en: {
      ...
      prueba: ['USD 9.99 a month. The price is not bait: there is no pro tier.', 'Zero analytics and zero ads: three cookies, nothing else.', '14-day refund, no questions.'],
  ...
  global: {
    es: {
      ...
      prueba: ['USD 9.99 al mes, cancelas cuando quieras.', 'Devolución de 14 días, sin preguntas.', 'Contenido en español e inglés.'],
    ...
    en: {
      ...
      prueba: ['USD 9.99 a month, cancel whenever you want.', '14-day refund, no questions.', 'Content in Spanish and English.'],
