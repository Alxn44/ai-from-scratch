...
export const NARRATIVA: Record<Mercado, { es: Copy; en: Copy }> = {
  co: {
    es: {
      ...
      moneda: 'USD 9.99 · lo convierte tu banco',
    },
    en: {
      ...
      moneda: 'USD 9.99 · converted by your bank',
    },
  },
  latam: {
    es: {
      ...
      prueba: ['Contenido en español e inglés, lo cambias en un clic.', 'Un pago de USD 9.99, acceso indefinido.', 'Responde una persona, en menos de 24 h hábiles.'],
    ...
    en: {
      ...
      prueba: ['Content in Spanish and English, switched in one click.', 'One payment of USD 9.99, open-ended access.', 'A person answers, in under 24 business hours.'],
  ...
  global: {
    es: {
      ...
      prueba: ['Un pago de USD 9.99, acceso indefinido.', 'Devolución de 14 días, sin preguntas.', 'Contenido en español e inglés.'],
