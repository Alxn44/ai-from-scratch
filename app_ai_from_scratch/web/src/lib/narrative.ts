...
export const NARRATIVA: Record<Mercado, { es: Copy; en: Copy }> = {
  co: {
    es: {
      ...
      prueba: ['Lo escribió una persona con nombre y correo, en Medellín.', '38.500 COP al mes. Sin permanencia: cancelas en un clic.', 'PSE, efectivo en Efecty, tarjeta o wallet.'],
      pagoTit: 'Cómo pagas desde Colombia',
      pagoTxt: 'El cobro lo procesa Mercado Pago y el precio está en pesos: 38.500 COP es lo que te aparece en el extracto, sin conversión y sin comisión de cambio.',
      ...
      moneda: '38.500 COP al mes · en pesos, sin conversión',
    },
    en: {
      ...
      prueba: ['Written by one person with a name and an email, in Medellín.', '38,500 COP a month. No minimum term: cancel in one click.', 'Card, PSE, cash at Efecty or the Mercado Pago wallet.'],
      pagoTit: 'How you pay from Colombia',
      pagoTxt: 'Mercado Pago processes the charge and the price is in Colombian pesos: 38,500 COP is what lands on the statement, with no conversion and no FX fee.',
      ...
      moneda: '38,500 COP a month · in pesos, no conversion',
    },
  },
  latam: {
    es: {
      ...
      prueba: ['Contenido en español e inglés, lo cambias en un clic.', '38.500 COP al mes, cancelas cuando quieras.', 'Responde una persona, en menos de 24 h hábiles.'],
      ...
      moneda: '38.500 COP al mes · lo convierte tu banco',
    },
    en: {
      ...
      prueba: ['Content in Spanish and English, switched in one click.', '38,500 COP a month, cancel whenever you want.', 'A person answers, in under 24 business hours.'],
      ...
      moneda: '38,500 COP a month · converted by your bank',
    },
  },
  us: {
    es: {
      ...
      prueba: ['38.500 COP al mes. El precio no es un gancho: no hay plan pro.', 'Cero analítica y cero anuncios: tres cookies y nada más.', 'Devolución de 14 días, sin preguntas.'],
    ...
    en: {
      ...
      prueba: ['38,500 COP a month. The price is not bait: there is no pro tier.', 'Zero analytics and zero ads: three cookies, nothing else.', '14-day refund, no questions.'],
  ...
  global: {
    es: {
      ...
      prueba: ['38.500 COP al mes, cancelas cuando quieras.', 'Devolución de 14 días, sin preguntas.', 'Contenido en español e inglés.'],
    ...
    en: {
      ...
      prueba: ['38,500 COP a month, cancel whenever you want.', '14-day refund, no questions.', 'Content in Spanish and English.'],
