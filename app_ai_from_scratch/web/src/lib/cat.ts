...
// LA MARCHA NO VIVE AQUI. Vive en cat3d.ts, que es un rig 3D por capas con
// cinematica inversa. Este fichero dibuja a Conito QUIETO — de frente, en un
// solo SVG plano — y eso es lo correcto para el panel de IA y las tarjetas: una
// mascota que se agita mientras lees compite con la leccion.
//
// Hubo aqui un `pose:'anda'` de perfil con las cuatro patas en keyframes CSS de
// periodo fijo. Se quito porque no podia NO patinar: quien movia al gato era
// GSAP con su propia curva y las patas iban por su cuenta. En registro.astro
// ademas ni siquiera se desplazaba — caminaba en el sitio, sobre una cinta.
