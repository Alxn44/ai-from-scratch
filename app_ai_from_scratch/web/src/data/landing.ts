...
const FAQS_ES: Faq[] = [
  ...
  { q:"¿Y si no me sirve?", a:"Tienes 14 días para escribirme y recibir un reembolso completo de los $35.000. Sin formularios ni preguntas." },
  ...
  { q:"¿Es pago único o suscripción?", a:"Suscripción de $35.000 COP al mes. Se renueva sola hasta que la canceles, y mientras esté activa tienes todo el Vol. 1 con sus actualizaciones incluidas. Cancelas en un clic desde tu perfil: sigues entrando hasta el final del mes que ya pagaste." },
...
const FAQS_EN: Faq[] = [
  ...
  { q:"What if it is not for me?", a:"You have 14 days to email me and get the full 35,000 COP back. No forms, no questions." },
  ...
  { q:"Is it a one-off payment or a subscription?", a:"A subscription: 35,000 COP a month. It renews on its own until you cancel, and while it is active you get all of Vol. 1 with its updates included. Cancel in one click from your profile: you keep access until the end of the month you already paid for." },
...
const MICRO_ES: string[] = ["01·LA IA","TOKENS","+","70.000.000.000","ES/EN","×","94→23→4","$35.000","//","T=0.30","12/12","CONTEXTO","suena ≠ cierto","·","100.000","FRÍO","CALIENTE","→","perillas","05·CÓMO LEE","31/100","IA","∞","1 vez","carta|gena","AD","09·PERILLA","memoria: ayer","•","internet: hoy","qué+quién+cómo","○","4:5","1080×1350","12 LECCIONES","−","error↓","no sé","□","5 min/día","06·ESCRIBE","suave 12","azul ~0","△","ES","EN","+","bueno 31","Max","Sr. Mostacho","／","3 palabras","5 tokens","·","10·PELIGRO","verifícalo","◇","08·MESA","se llena","lo viejo cae","×","07·PEDIRLE","genérico","≠","04·NO CAMBIA","libro impreso","·","02·MEJORA","frío/caliente","+","03·PERILLAS","70B","○","11·FECHA","corte","hoy","→","12·EMPIEZA","copia","pega","·","40 min","garantía 14d","+","$35.000/mes","cancelas cuando quieras","×","@alxn_dev_ai","IA fácil","·","2160×2700","PNG 2×","○","carrusel","·","VOL. 1","fundamentos","+","AD"];

const MICRO_EN: string[] = ["01·WHAT AI IS","TOKENS","+","70 billion","ES/EN","×","94→23→4","35,000 COP","//","T=0.30","12/12","CONTEXT","fluent ≠ true","·","100,000","COLD","HOT","→","dials","05·HOW IT READS","31/100","AI","∞","once","beaut|iful","AD","09·THE DIAL","memory: yesterday","•","internet: today","what+who+how","○","4:5","1080×1350","12 LESSONS","−","error↓","I don't know","□","5 min/day","06·HOW IT WRITES","soft 12","blue ~0","△","ES","EN","+","good 31","Max","Mr. Whiskers","／","3 words","5 tokens","·","10·THE DANGER","check it","◇","08·THE TABLE","fills up","the old falls off","×","07·HOW TO ASK","generic","≠","04·NO CHANGE","printed book","·","02·IMPROVING","hot/cold","+","03·DIALS","70B","○","11·CUTOFF","cutoff","today","→","12·START","copy","paste","·","40 min","14-day refund","+","35,000 COP/mo","cancel anytime","×","@alxn_dev_ai","AI made easy","·","2160×2700","PNG 2×","○","carousel","·","VOL. 1","fundamentals","+","AD"];

const TICKER_ES: string[] = ["12 LECCIONES","·","ES / EN","·","40 MIN DE LECTURA","·","1080 × 1350","·","$35.000 AL MES","·","GARANTÍA 14 DÍAS","·","9 PROMPTS INCLUIDOS","·","MI HARNESS DE CLAUDE CODE","·","SIN CÓDIGO","·","SIN FÓRMULAS","·","CANCELAS CUANDO QUIERAS","·","ACTUALIZACIONES DEL VOL. 1","·","FUNDAMENTOS · VOL. 1","·","@ALXN_DEV_AI","·"];

const TICKER_EN: string[] = ["12 LESSONS","·","ES / EN","·","40 MIN READ","·","1080 × 1350","·","35,000 COP A MONTH","·","14-DAY REFUND","·","9 PROMPTS INCLUDED","·","MY CLAUDE CODE HARNESS","·","NO CODE","·","NO FORMULAS","·","CANCEL ANYTIME","·","VOL. 1 UPDATES","·","FUNDAMENTALS · VOL. 1","·","@ALXN_DEV_AI","·"];
