...
export const FAQS: Faq[] = [
  ...
  { q:"¿Es pago único o suscripción?", a:"Pago único de $9.99 USD. Acceso de por vida, y las actualizaciones futuras te llegan sin pagar otra vez." },
...
export const MICRO: string[] = ["01·LA IA","TOKENS","+","70.000.000.000","ES/EN","×","94→23→4","$9.99","//","T=0.30","12/12","CONTEXTO","suena ≠ cierto","·","100.000","FRÍO","CALIENTE","→","perillas","05·CÓMO LEE","31/100","IA","∞","1 vez","carta|gena","AD","09·PERILLA","memoria: ayer","•","internet: hoy","qué+quién+cómo","○","4:5","1080×1350","12 LECCIONES","−","error↓","no sé","□","5 min/día","06·ESCRIBE","suave 12","azul ~0","△","ES","EN","+","bueno 31","Max","Sr. Mostacho","／","3 palabras","5 tokens","·","10·PELIGRO","verifícalo","◇","08·MESA","se llena","lo viejo cae","×","07·PEDIRLE","genérico","≠","04·NO CAMBIA","libro impreso","·","02·MEJORA","frío/caliente","+","03·PERILLAS","70B","○","11·FECHA","corte","hoy","→","12·EMPIEZA","copia","pega","·","40 min","garantía 14d","+","pago único","de por vida","×","@alxn_dev_ai","IA fácil","·","2160×2700","PNG 2×","○","carrusel","·","VOL. 1","fundamentos","+","AD"];

export const TICKER: string[] = ["12 LECCIONES","·","ES / EN","·","40 MIN DE LECTURA","·","1080 × 1350","·","PAGO ÚNICO $9.99","·","GARANTÍA 14 DÍAS","·","9 PROMPTS INCLUIDOS","·","MI HARNESS DE CLAUDE CODE","·","SIN CÓDIGO","·","SIN FÓRMULAS","·","ACCESO DE POR VIDA","·","ACTUALIZACIONES DEL VOL. 1","·","FUNDAMENTOS · VOL. 1","·","@ALXN_DEV_AI","·"];
