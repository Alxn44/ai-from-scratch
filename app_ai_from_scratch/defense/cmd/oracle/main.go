...
var thresholds = []threshold{
	...
	{"auth.login_locked", 3, finding.High, policy.ThrottleIdentity,
		"repeated attempts against an already locked account are deliberate pressure, not password recovery"},
	...
	{"subscription.entitlement_revoked", 3, finding.High, policy.ReviewSubscription,
		"repeated entitlement reversals can indicate chargebacks, webhook disorder, or subscription abuse and require financial review"},
	{"subscription.checkout_started", 8, finding.High, policy.ThrottleIdentity,
		"repeated subscription checkout creation consumes provider resources and is not normal buying behaviour"},
