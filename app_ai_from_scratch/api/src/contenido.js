// Texto de enseñanza de cada lección: explicación técnica, analogía y ejemplos
// resueltos. Reglas de escritura (las mismas del carrusel):
//   · técnica: 90-140 palabras, mecanismo exacto, cero jerga sin traducir
//   · analogía: 50-80 palabras, UNA sola metáfora, cotidiana
//   · ejemplos: 2 casos concretos con entrada, salida y por qué
// El lab viene DESPUÉS de esto: si el lab no se puede resolver leyendo esta
// página, el texto está mal escrito, no el lab.
