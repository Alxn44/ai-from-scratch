...
// moneda no dice nada — 38500 es un precio razonable en pesos y absurdo en dolares.
...
ok(precio.precio.monto === 38500 && precio.precio.moneda === 'COP' && precio.garantiaDias === 14,
   '«¿cuánto cuesta?» → 38.500 COP y 14 días de garantía');
